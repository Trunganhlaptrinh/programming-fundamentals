...
public class Validation {
    ...
    public String checkPhone(String message) {
        while (true) {
            ...
            // dieu kien: so + > 10 ki tu
            if (input.matches("^[0-9]+$")) {
                if (input.length() >= 10) {
                    return input;
                }
            }
            System.err.println("Phone must be number only and > 10 characters");
    ...
    public String checkDegree(String message) {
        while (true) {
            System.out.print(message);
            String input = sc.nextLine().trim();
            if (input.isEmpty()) {
...
//            }
    ...
    public int checkGraduationRank(String mess, int birth) {
        while (true) {
            System.out.print(mess);
            String input = sc.nextLine().trim();
            if (input.isEmpty()) {
